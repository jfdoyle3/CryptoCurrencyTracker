...
public class TestDateTimeUtils {
	...
	public static void main(String[] args) throws ParseException {
		...
		String time2 = "2010-01-18 15:15:00";
		...
		double days = DateTimeUtils.calculateDays(unixTime1, unixTime2);
		double minutes = DateTimeUtils.calculateMinutes(unixTime1, unixTime2);
