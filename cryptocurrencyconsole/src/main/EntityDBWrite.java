...
public class EntityDBWrite {
	...
	public static void main(String[] args) {
		...
		SessionFactory factory = new Configuration().configure().addAnnotatedClass(Cryptocurrencies.class)
				.addAnnotatedClass(CurrencyInfo.class).addAnnotatedClass(Intervals.class).buildSessionFactory();
